...
leftOrRight = "L"
train = load_from_folder(30, leftOrRight, baseFolder, maskFolder, (64, 64), True)
test = load_from_folder(10, leftOrRight, baseFolder, maskFolder, (64, 64), True)
val = load_from_folder(5, leftOrRight, baseFolder, maskFolder, (64, 64), True)
